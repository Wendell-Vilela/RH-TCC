...
import br.com.biblioteca.controller.EditoraController;
...
public class TelaEditoras extends JPanel {

  private final JTextField id = new JTextField(7),
    nome = new JTextField(30),
    cidade = new JTextField(25),
  ...
  private final EditoraController controller;
  ...
  private void montar() {
    ...
    f.setBorder(BorderFactory.createTitledBorder("Cadastro de editoras"));
    GridBagConstraints g = new GridBagConstraints();
    g.insets = new Insets(4, 4, 4, 4);
    campo(f, g, 0, "Codigo:", id);
    campo(f, g, 1, "Nome*:", nome);
    campo(f, g, 2, "Cidade:", cidade);
  ...
  public void mostrar(Editora a) {
    id.setText(String.valueOf(a.getId()));
    nome.setText(a.getNome());
    cidade.setText(a.getCidade());
  }

  public void preencher(List<Editora> l) {
