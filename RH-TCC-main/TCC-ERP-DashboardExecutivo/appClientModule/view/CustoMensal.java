...
public class CustoMensal extends JPanel {
    ...
    private void montar() {
        ...
        investimentoTotallbl.setForeground(Color.WHITE);
        investimentoTotaltxt.setForeground(Color.WHITE);
        ...
        salarioTotallbl.setForeground(Color.WHITE);
        salarioTotaltxt.setForeground(Color.WHITE);
        ...
        encargoTotallbl.setForeground(Color.WHITE);
        encargoTotaltxt.setForeground(Color.WHITE);
        ...
        beneficioTotallbl.setForeground(Color.WHITE);
        beneficioTotaltxt.setForeground(Color.WHITE);
